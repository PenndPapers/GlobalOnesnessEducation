...
const About = () => {
    return (
        <section className='w-5/6 mx-auto mt-16 md:mt-32 mb-10  '>
            <h1 className='text-xl sm:text-4xl my-5 '> know about <span className='font-bold '>GLOBAL ONENESS </span> </h1>
            <div className='sm:flex sm:flex-row  justify-between  items-center  '>
                ...
                <div className=' flex flex-col gap-5 w-full  sm:w-[60%]   '>
